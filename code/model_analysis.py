...
test_ds = tf.data.Dataset.load("input_data/datasets/noise/25/test_set_noise_25")
EPOCHS = 50
BATCH = 16
IMG_SHAPE = (224, 224, 3)

model = tf.keras.models.load_model("output/resnet/noise/25/resnet50v2_25_noise.keras", compile=True)
y_true = []
y_pred = []
times = []
for x, y in test_ds:
