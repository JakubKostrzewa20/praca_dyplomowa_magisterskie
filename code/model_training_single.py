...
fig.suptitle(
    "Training and Validation Metrics — ResNet50 with 100% of data", fontsize=16
)
...
plt.savefig(
    "output/plots/training_metrics_resnet50_100_new.png", dpi=300, bbox_inches="tight"
)

model.save("output/resnet/100/resnet50_100_new.keras")
